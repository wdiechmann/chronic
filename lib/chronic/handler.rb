      ...
      @pattern.each do |element|
        ...
        when String
          ...
          if definitions.key?(name.to_sym)
            ...
            raise ChronicPain, I18n.t(:invalid_subset_specified, name: name, scope: 'chronic.pains' )
          end
          ...
          raise ChronicPain, I18n.t(:invalid_match_type, element_class: element.class, scope: 'chronic.pains')
        end
      end
